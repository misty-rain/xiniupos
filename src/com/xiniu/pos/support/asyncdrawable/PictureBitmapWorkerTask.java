...
import com.xiniu.pos.support.imagetool.ImageTool;
...
public class PictureBitmapWorkerTask extends MyAsyncTask<String, Void, Bitmap> {
    ...
    protected Bitmap doInBackground(String... url) {
        ...
        int avatarWidth = globalContext.getResources().getDimensionPixelSize(R.dimen.list_avatar_width);
        int avatarHeight = globalContext.getResources().getDimensionPixelSize(R.dimen.list_avatar_height);

        int thumbnailWidth = globalContext.getResources().getDimensionPixelSize(R.dimen.list_pic_thumbnail_width);
        int thumbnailHeight = globalContext.getResources().getDimensionPixelSize(R.dimen.list_pic_thumbnail_height);
        ...
        if (!isCancelled()) {
            switch (method) {
                ...
                case picture_bmiddle:
                    ...
                    int height = globalContext.getResources().getDimensionPixelSize(R.dimen.list_pic_high_thumbnail_height);
                    //8 is  layout padding
    ...
    private void playImageViewAnimation(final ImageView view, final Bitmap bitmap) {
        final Animation anim_out = AnimationUtils.loadAnimation(view.getContext(), R.anim.list_pic_fade_out);
        final Animation anim_in = AnimationUtils.loadAnimation(view.getContext(), R.anim.list_pic_fade_in);
