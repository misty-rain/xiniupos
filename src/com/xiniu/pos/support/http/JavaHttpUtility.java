package com.xiniu.pos.support.http;
...
import com.xiniu.pos.support.file.FileUploaderHttpHelper;
...
public class JavaHttpUtility {
    ...
    public String doPost(String urlAddress, Map<String, String> param) throws Exception {
        ...
        try {
            ...
            e.printStackTrace();
            throw new AppException(errorStr, e);
        }
    }
    ...
    private String handleError(HttpURLConnection urlConnection) throws AppException {
    ...
    private String readError(HttpURLConnection urlConnection) throws AppException {
        ...
        try {
            ...
            if (is == null) {
                errorStr = globalContext.getString(R.string.http_exception_error);
    ...
    public boolean doUploadFile(String urlStr, Map<String, String> param, String path, final FileUploaderHttpHelper.ProgressListener listener) throws AppException {
