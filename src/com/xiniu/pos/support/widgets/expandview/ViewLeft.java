...
public class ViewLeft extends RelativeLayout implements ViewBaseAction{
	...
	private void init(Context context) {
		...
		adapter = new ExpandTextAdapter(context, items, R.drawable.choose_item_right, R.drawable.choose_eara_item_selector);
		...
		adapter.setOnItemClickListener(new ExpandTextAdapter.OnItemClickListener() {
