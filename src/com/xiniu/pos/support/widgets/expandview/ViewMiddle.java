package com.xiniu.pos.support.widgets.expandview;
...
import com.xiniu.pos.ui.adapter.ExpandTextAdapter;
...
public class ViewMiddle extends LinearLayout implements ViewBaseAction {
	...
	private void init(Context context) {
		...
		earaListViewAdapter = new ExpandTextAdapter(context, groups,
		...
		earaListViewAdapter
				.setOnItemClickListener(new ExpandTextAdapter.OnItemClickListener() {
		...
		plateListViewAdapter = new ExpandTextAdapter(context, childrenItem,
