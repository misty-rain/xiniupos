...
public class ExpandTextAdapter extends ArrayAdapter<String> {
	...
	public ExpandTextAdapter(Context context, List<String> listData, int sId, int nId) {
		super(context, R.string.message_no_data, listData);
		mContext = context;
		mListData = listData;
	...
	public ExpandTextAdapter(Context context, String[] arrayData, int sId, int nId) {
		super(context, R.string.message_no_data, arrayData);
		mContext = context;
